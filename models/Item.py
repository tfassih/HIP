...
class Item(Base):
    ...
    physical_weight_unit = Column(String, nullable=True)
    physical_height = Column(Float, nullable=True)
    physical_height_unit = Column(String, nullable=True)
    physical_width = Column(Float, nullable=True)
    physical_width_unit = Column(String, nullable=True)
    physical_length = Column(Float, nullable=True)
    physical_length_unit = Column(String, nullable=True)
